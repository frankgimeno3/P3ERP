...
const Fase1: FC<Fase1Props> = ({ setFaseCrearContacto }) => {
  ...
  return (
    ...
    <div className='flex flex-col gap-6 px-24'>
      <button onClick={() => { router.push('/dashboard/comercial/contactos') }} className='bg-gray-100 hover:bg-gray-100/50 text-sm border border-gray-100 shadow-lg cursor-pointer rounded-lg px-3 py-1'>
