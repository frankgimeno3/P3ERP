...
const dashboardRoutes = [
  ...
  '/dashboard/produccion/gestiones_produccion',
  '/dashboard/produccion/gestiones_produccion/publicado_cancelado',
  '/dashboard/produccion/gestiones_produccion/materiales',
  '/dashboard/produccion/gestiones_produccion/materiales/[id_material]',
  '/dashboard/produccion/gestiones_produccion/articulos',
  '/dashboard/produccion/gestiones_produccion/articulos/[id_articulo]',
...
const roleSections: Record<string, string[]> = {
  empleado: ["dashboard", "comercial", "produccion"],
